                        ...
                        <div class="row m-0">
                            <div class="col s12">
                                <div class="card-panel z-depth-1">
                                    <div class="row valign-wrapper column-flow m-0">
                                        <?php
                                        if (isset($_SESSION['admin'])) {
                                        ...
                                        <div class="col s12">
                                            ...
                                            <div class="input-group column-flow hide flex-between">
                                                ...
                                                <div class="left-align col s12 m5 p-0">
                                        ...
                                        ?>
                                        <div class="col s12 <?php echo (isset($_SESSION['admin']) ? "s6" : "s12") ?>">
                                            <div class="text-label flex-between">
                                                <div class="black-text">
                                ...
                                <div class="card-panel z-depth-1">
                                    <div class="row valign-wrapper m-0">
                                        ...
                                        <div id="personalImage" class="modal">
                                            <div class="modal-content center-mobile">
                                                <div class="row p-0 m-0 modal-preview column-flow">
                                                    ...
                                                    <div class="col s12 m8 p-img">
                                                        <h6>ملاحظات:</h6>
                                                        <p>لا تنسى يجب أن تكون الصورة بأبعاد [200*150].</p>
                                                        <p>لا تنسى يجب أن تكون الصورة بخلفية بيضاء.</p>
                                                        <div class="row flex-between input-btn column-flow" style="margin-bottom:0">
                                                            <div class="input-field file-field col s12 l8 p-0">
                                                                <div class="btn">
                                                                    <span><i class="material-icons">person_outline</i></span>
                            ...
                            <div class="col s12">
                                <div class="card-panel z-depth-1">
                                    <div class="row valign-wrapper column-wrap m-0">
                                        <!-- ID Card Image -->
                                        <div class="col s6 m3 l1 p-0 center-align file-type">
                                        ...
                                        <div id="idPersonCard" class="modal">
                                            <div class="modal-content center-mobile">
                                                <div class="row p-0 m-0 modal-preview column-flow">
                                                    ...
                                                    <div class="col s12 l8 p-img">
                                                        <h6>ملاحظات:</h6>
                                                        <p>يجب إدخال صورة واحدة فقط تحتوي على الجانبين للبطاقة الشخصية.</p>
                                                        <div class="flex-between input-btn column-flow" style="margin-bottom:0">
                                                            <div class="input-field file-field col s12 l8 p-0">
                                                                <div class="btn">
                                                                    <span><i class="material-icons">payment</i></span>
                                        ...
                                        <!-- Contract Image -->
                                        <div class="col s6 m3 l1 p-0 center-align file-type">
                                            <img src="../images/default/contract.svg" data-target="contract" alt="Contract Image" class="modal-trigger responsive-img prwaz tooltipped" data-position="bottom" data-tooltip="تعديل عقد العمل" style="padding:6px">
                            ...
                            <div class="col s12">
                                <div class="my-wrapper">
                                    ...
                                    <div class="card-panel z-depth-1 remove-space">
                                        <div class="row valign-wrapper column-flow m-0">
                                            <div class="col s12 l6">
                                                <div class="text-label flex-between">
                                                    <div class="black-text">
                                            ...
                                            <div class="col s12 l6">
                                                ...
                                                <div class="input-group hide">
                                                    <div class="col s12">
                                                        ...
                                                        <div class="input-field margin-mobaile col s6 m4 l3">
                                                        ...
                                                        <div class="input-field margin-mobaile col s6 m4 l4">
                                ...
                                <div class="card-panel z-depth-1">
                                    <div class="row valign-wrapper m-0">
                                        <div class="col s12">
                                            ...
                                            <div class="input-group row m-0 flex-between column-flow hide">
                                                <div class="input-field col s12 m6">
                        ...
                        <div id="invoice" class="modal cart-modal">
                            <div class="modal-content">
                                ...
                                <!-- <div class="modal-line <?php// echo (!empty($trans['visa']) ? "" : "hide"); ?>">
                                    <div class="row m-0">
                                        <div class="col s9 p-0"><span>التأشيرة</span> <strong id="visaNameInvoice">(<?php// echo $trans['visa']; ?>)</strong></div>
                                        <div class="col s3 p-0 left-align">
