    ...
    <form method="post" action="include/login.php">
      ...
      <div class="row m-0">
        <div class="input-field col s12">
          <input id="usermail" name="UOE" value="<?php echo (isset($Row) ? $Row[0] : ""); ?>" type="text" class="validate">
          <label for="usermail">Username or email</label>
        </div>
      </div>
      <div class="row m-0">
        <div class="input-field col s12">
          <input id="password" name="password" value="<?php echo (isset($Row) ? $Row[1] : ""); ?>" type="password" class="validate">
